...
var hue_value : float = 238
var saturation_value : float = 82
var brightness_value : float = 70

signal pants_color_changed(hue_value, saturation_value, brightness_value)
...
func _on_Hue_value_changed(value):
	hue.text = "%d" %value
	hue_value = value 
	emit_signal("pants_color_changed", hue_value/360, saturation_value/100, brightness_value/100)
